    ...
    <div className="relative min-h-screen overflow-x-clip">
      ...
      <header className="relative z-10 border-b-2 border-ink/85 bg-paper/70">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center gap-4 px-5 py-4">
          <DonorLogo size={84} radius={14} />
          <div className="min-w-0">
            <p className="font-display text-[21px] font-bold leading-none tracking-tight text-ink">
              Стикер в <span className="text-green">1С</span>
            </p>
            <p className="mt-1.5 text-[12px] leading-none text-ink-soft">
              мастер конвертации сметного листа · перенос макроса «Стикер_1С»
            </p>
          </div>
          <OneCLogo size={76} radius={14} />
